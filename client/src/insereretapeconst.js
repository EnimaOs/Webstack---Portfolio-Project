...
function Insereretapeconst() {
    ...
    useEffect(() => {
        const fetchProjects = async () => {
            try {
              const response = await axios.post("http://localhost:5000/charger");
    ...
    useEffect(() => {
        const fetchPlan = async () => {
            try {
              const response = await axios.post('http://localhost:5000/plan');
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
          ...
          const response = await axios.post("http://localhost:5000/inserer", { Data: formData, project_id: selectedProject, id_plan: plaan, etape: constr });
